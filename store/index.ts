...
import type { User, Address, Shipment, Driver, Vehicle, Wallet, Transaction, Quote, Notification, Branch, KPIData, ActivityItem, Warehouse, CustomsDocument } from '@/types';
...
const mockShipments: Shipment[] = [
  {
    ...
    trackingEvents: [
      { id: 'e1', shipmentId: 's1', eventType: 'booked', description: 'Shipment booked and payment confirmed', locationName: 'Atlanta, GA', country: 'US', occurredAt: '2026-03-15T10:30:00Z' },
      { id: 'e2', shipmentId: 's1', eventType: 'pickup_assigned', description: 'Driver Adebayo Ogundimu assigned for pickup', locationName: 'Atlanta, GA', country: 'US', occurredAt: '2026-03-15T11:00:00Z' },
      { id: 'e3', shipmentId: 's1', eventType: 'picked_up', description: 'Package collected from sender', locationName: 'Atlanta, GA', country: 'US', occurredAt: '2026-03-15T14:30:00Z' },
      { id: 'e4', shipmentId: 's1', eventType: 'at_warehouse', description: 'Package received at Atlanta Hub', locationName: 'Atlanta Hub', country: 'US', occurredAt: '2026-03-15T18:00:00Z' },
      { id: 'e5', shipmentId: 's1', eventType: 'processing', description: 'Customs documentation in progress', locationName: 'Atlanta Hub', country: 'US', occurredAt: '2026-03-16T09:00:00Z' },
      { id: 'e6', shipmentId: 's1', eventType: 'customs_pending', description: 'Export customs cleared', locationName: 'Atlanta Hub', country: 'US', occurredAt: '2026-03-16T15:00:00Z' },
      { id: 'e7', shipmentId: 's1', eventType: 'in_transit_international', description: 'Departed via DHL Air Freight', locationName: 'Hartsfield-Jackson Airport', country: 'US', occurredAt: '2026-03-17T08:00:00Z' },
      { id: 'e8', shipmentId: 's1', eventType: 'in_transit_international', description: 'Arrived at Lagos Airport', locationName: 'Murtala Muhammed Airport', country: 'NG', occurredAt: '2026-03-18T06:30:00Z' },
    ],
  },
  {
    id: 's2',
  ...
  },
  {
    ...
    customsDocsStatus: 'pending',
    hsCode: '8481.80',
    createdAt: '2026-03-01T06:00:00Z',
    trackingEvents: [
      { id: 'e13', shipmentId: 's3', eventType: 'booked', description: 'Freight booking confirmed', locationName: 'Guangzhou, CN', country: 'CN', occurredAt: '2026-03-01T06:00:00Z' },
      { id: 'e14', shipmentId: 's3', eventType: 'picked_up', description: 'Container loaded at supplier warehouse', locationName: 'Guangzhou, CN', country: 'CN', occurredAt: '2026-03-03T10:00:00Z' },
      { id: 'e15', shipmentId: 's3', eventType: 'at_warehouse', description: 'Arrived at Shanghai Port', locationName: 'Shanghai, CN', country: 'CN', occurredAt: '2026-03-05T14:00:00Z' },
      { id: 'e16', shipmentId: 's3', eventType: 'in_transit_international', description: 'Departed Shanghai Port - MV Pacific Glory', locationName: 'Pacific Ocean', country: 'XX', occurredAt: '2026-03-08T08:00:00Z' },
      { id: 'e17', shipmentId: 's3', eventType: 'in_transit_international', description: 'Arrived at Lagos Port - Customs processing required', locationName: 'Apapa Port, Lagos', country: 'NG', occurredAt: '2026-03-17T16:00:00Z' },
      { id: 'e18', shipmentId: 's3', eventType: 'customs_pending', description: 'Awaiting customs clearance - Form M required', locationName: 'Apapa Port, Lagos', country: 'NG', occurredAt: '2026-03-18T09:00:00Z' },
    ],
  },
  {
    id: 's4',
    ...
    trackingEvents: [
      { id: 'e19', shipmentId: 's4', eventType: 'booked', description: 'Express document shipment booked', locationName: 'London, UK', country: 'GB', occurredAt: '2026-03-15T12:00:00Z' },
      { id: 'e20', shipmentId: 's4', eventType: 'picked_up', description: 'Documents collected', locationName: 'London, UK', country: 'GB', occurredAt: '2026-03-15T15:00:00Z' },
      { id: 'e21', shipmentId: 's4', eventType: 'in_transit_international', description: 'Flown to Lagos - BA Flight 257', locationName: 'Lagos Airport', country: 'NG', occurredAt: '2026-03-16T08:00:00Z' },
      { id: 'e22', shipmentId: 's4', eventType: 'customs_cleared', description: 'Documents - No duties applicable', locationName: 'Lagos, NG', country: 'NG', occurredAt: '2026-03-16T12:00:00Z' },
      { id: 'e23', shipmentId: 's4', eventType: 'out_for_delivery', description: 'Out for delivery', locationName: 'Abuja', country: 'NG', occurredAt: '2026-03-17T08:00:00Z' },
      { id: 'e24', shipmentId: 's4', eventType: 'delivered', description: 'Delivered and signed - Chief Okonkwo', locationName: 'Abuja, NG', country: 'NG', occurredAt: '2026-03-17T14:30:00Z' },
    ],
  },
];
