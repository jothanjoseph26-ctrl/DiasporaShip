...
export interface Shipment {
  ...
  exceptionType?: 'missing_customs_document' | 'failed_first_delivery_attempt' | 'none';
  hsCode?: string;
  customsOfficer?: string;
  deliveryAttempts?: number;
  podRecipientName?: string;
  podLocationName?: string;
  podPhotoUrl?: string;
  podSignatureUrl?: string;
  podDeliveredAt?: string;
  proofOfDeliveryMethod?: 'photo' | 'signature' | 'otp' | 'handoff_code';
  proofOfDeliveryCode?: string;
  proofOfDeliveryLocation?: string;
